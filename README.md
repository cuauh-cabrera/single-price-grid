...
**[ Single Price Grid Component ]** This challenge is to build out a pricing component and get it looking as close to the design as possible.
...
- https://cuauh-cabrera.github.io/single-price-grid/
...
```sh
  cd my-folder
  git@github.com:cuauh-cabrera/single-price-grid.git
```
